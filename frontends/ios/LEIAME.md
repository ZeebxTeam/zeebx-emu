...
`frontends/ios/build/iphoneos/`. Sem `DEVELOPMENT_TEAM` o do aparelho não é assinado: serve
para saber que o link fecha, não para instalar. Para instalar num telefone:
